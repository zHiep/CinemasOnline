 <div class="modal fade  modal-lg" id="profileModal{!! $value['id'] !!}" tabindex="-1"
     aria-labelledby="profileModalLabel" aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title text-center" id="profileModalLabel">@lang('lang.ticket_code') : {!!
                     $value['code'] !!}</h5>
                 ...
                 <div class="card-body">
                     <div class="row">
                         ...
                         <div class="d-flex justify-content-end ">
                             <button href="#billModal" data-toggle="tooltip"
                                 data-bs-target="#billModal{!! $value['id'] !!}" data-bs-toggle="modal"
                                 class="btn btn-danger m-2" style="width: 130px;">Xem chi tiết Hóa đơn</button>
                         </div>
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td class="align-middle text-center">
                                         ...
                                         <p>@lang('lang.from') {!! date("H:i
                                             A",strtotime($value['schedule']['startTime'] )) !!} ~ @lang('lang.to') {!!
                                             date("H:i A",strtotime($value['schedule']['endTime'] )) !!}</p>
                                     </td>
                                     <td class="align-middle text-center">
