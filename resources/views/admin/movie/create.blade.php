                ...
                <form method="post" action="/admin/movie/create" enctype="multipart/form-data">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <button type="submit"
                                class="btn bg-gradient-primary btn-sm ms-auto">@lang('lang.submit')</button>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input id="showTime" class="form-control" name="showTime"
                                        placeholder="@lang('lang.showtime')" type="number" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="national" id="national">
                                        ...
                                        <option value="British Indian Ocean Territory">Lãnh thổ Ấn Độ Dương thuộc Anh
                                        </option>
                                        ...
                                        <option value="Congo, Democratic Republic of the Congo">Congo, Cộng hòa Dân chủ
                                            Congo</option>
                                        ...
                                        <option value="Falkland Islands (Malvinas)">Quần đảo Falkland (Malvinas)
                                        </option>
                                        ...
                                        <option value="Heard Island and Mcdonald Islands">Đảo Heard và Quần đảo McDonald
                                        </option>
                                        <option value="Holy See (Vatican City State)">Tòa thánh (Nhà nước thành phố
                                            Vatican)</option>
                                        ...
                                        <option value="Korea, Democratic People's Republic of">Hàn Quốc, Cộng hòa Dân
                                            chủ Nhân dân</option>
                                        <option value="Korea, Republic of">Hàn Quốc, Cộng hòa</option>
                                        <option value="Kosovo">Kosovo</option>
                                        <option value="Kuwait">Kuwait</option>
                                        <option value="Kyrgyzstan">Kyrgyzstan</option>
                                        <option value="Lao People's Democratic Republic">Cộng hòa Dân chủ nhân dân Lào
                                        </option>
                                        ...
                                        <option value="Macedonia, the Former Yugoslav Republic of">Macedonia, Cộng hòa
                                            Nam Tư cũ của</option>
                                        ...
                                        <option value="Palestinian Territory, Occupied">Lãnh thổ Palestine, bị chiếm
                                            đóng</option>
                                        ...
                                        <option value="Saint Vincent and the Grenadines">Saint Vincent và Grenadines
                                        </option>
                                        ...
                                        <option value="South Georgia and the South Sandwich Islands">Nam Georgia và Quần
                                            đảo Nam Sandwich
                                        </option>
                                        ...
                                        <option value="Tanzania, United Republic of">Tanzania, Cộng hòa Thống nhất
                                        </option>
                                        ...
                                        <option value="United Arab Emirates">các Tiểu Vương Quốc Ả Rập Thống Nhất
                                        </option>
                                        <option value="United Kingdom">Vương quốc Anh</option>
                                        <option value="United States">Hoa Kỳ</option>
                                        <option value="United States Minor Outlying Islands">Các đảo nhỏ xa xôi hẻo lánh
                                            của Hoa Kỳ</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="form-control btn bg-gradient-danger float-right mb-3"
                                        data-bs-toggle="modal" data-bs-target="#movie_genre">
                                        @lang('lang.select')
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="directors" class="form-control director-input" name="directors[]"
                                        multiple>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="releaseDate" id="releaseDate" class="form-control datepicker"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input id="endDate" name="endDate" class="form-control datepicker"
                                        placeholder="Please select date" type="text">
                                </div>
                            </div>
                            <div class="col-md-2">
...
<script>
    ...
    flatpickr($("#releaseDate"), {
        ...
        onChange: function(selectedDates, dateStr, instance) {
            ...
            if (endDatePicker) {
                endDatePicker.set("minDate", dateStr); // Đặt ngày tối thiểu cho endDate
            }
        }
    });
